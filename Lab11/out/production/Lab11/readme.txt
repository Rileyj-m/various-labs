...
2.) Both of these methods are really effective. they both work when testing all of the files. The runtimes of both of
these approaches are expected to be linearithmic and linear. O(n), and O(NlgN). The impact of the collision is really
non excistent because of the way that I am handling the collision. Insead of created a new key, I just update the keys
